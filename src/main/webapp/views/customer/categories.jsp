...
<html>
<head>
<title>TopZone Shop Categories</title>
<meta charset="utf-8">
						...
						<div class="col-md-6 text-right">
							<div class="top_nav_right">
								<ul class="top_nav_menu">
									...
									<li class="currency">Hotline 0938334550
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12 text-right">
							<div class="logo_container">
								<a href="/index">TopZ<span>oneShop</span></a>
							</div>
							<nav class="navbar">
				...
				<div class="col product_section clearfix">
					...
					<div class="sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								...
								<li class="active"><a href="#"><i
										class="fa fa-angle-double-right" aria-hidden="true"></i> Apple</a></li>
								<li><a href="#"> Oppo</a></li>
						...
						<div class="sidebar_section">
							...
							<ul class="checkboxes">
								<li class="active"><i class="fa fa-square"
									aria-hidden="true"></i><span>64GB</span></li>
								...
								<li><i class="fa fa-square-o" aria-hidden="true"></i><span>1TB</span></li>
							</ul>
						</div>
						...
						<div class="sidebar_section">
							...
							<ul class="checkboxes">
								<li class="active"><i class="fa fa-square"
									aria-hidden="true"></i><span>Điện thoại</span></li>
								<li><i class="fa fa-square-o" aria-hidden="true"></i><span>Laptop</span></li>
								<li><i class="fa fa-square-o" aria-hidden="true"></i><span>Tablet</span></li>
								<li><i class="fa fa-square-o" aria-hidden="true"></i><span>Phụ kiện</span></li>
								<li><i class="fa fa-square-o" aria-hidden="true"></i><span>Đồng hồ</span></li>
								<li><i class="fa fa-square-o" aria-hidden="true"></i><span>Máy cũ giá rẻ</span></li>
								<li><i class="fa fa-square-o" aria-hidden="true"></i><span>PC, máy in</span></li>
								<li><i class="fa fa-square-o" aria-hidden="true"></i><span>Sim, thẻ cào</span></li>
							</ul>
							<div class="show_more">
										...
										<ul class="product_sorting">
											<li><span class="type_sorting_text">Tất cả</span> <i
												...
												<ul class="sorting_type">
													...
													<a href="#"><li class="type_sorting_btn"><span>Vivo</span></li></a>
													<a href="#"><li class="type_sorting_btn"><span>Oppo</span></li></a>
												</ul></li>
									...
									<section class="items">
										<div class="product-grid row">
											...
											<c:forEach var="item" items="${listPhone}">
												<a href="/detail?idProduct=${item.maDT}">
													<div class="product-item col-4">
														<div class="product discount product_filter">
															...
															<div class="product_info">
																<h6 class="">
																	<a href="/detail?idProduct=${item.maDT}">${item.tenDT }</a>
																</h6>
														...
														<button data-masanpham="${item.maDT}"
						...
						<div class="col-lg-3 benefit_col">
							<div class="benefit_item d-flex flex-row align-items-center">
								...
								<div class="benefit_content">
									...
									<p>Miễn phí vận chuyển cho đơn hàng từ 3.000.000đ</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3 benefit_col">
						...
						<div class="col-lg-3 benefit_col">
							<div class="benefit_item d-flex flex-row align-items-center">
								...
								<div class="benefit_content">
									...
									<p>Miễn phí đổi trả cho đơn hàng lỗi nhà sản xuất</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3 benefit_col">
							...
							<div class="footer_nav_container">
								<div class="cr">
									©2023 All Rights Reserverd. Made with <i class="fa fa-heart-o"
										aria-hidden="true"></i> by <a href="#">PS24040 - PHUONGNTK</a>
								</div>
							</div>
						</div>
					</div>
