						...
						<div class="col-md-6 text-right">
							<div class="top_nav_right">
								<ul class="top_nav_menu">
									...
									<li class="currency1">Hotline 0938334550
								</ul>
							</div>
						</div>
					</div>
							...
							<nav class="navbar">
								...
								<c:choose>
									<c:when test="${empty sessionUsername}">
										<div class="">
											<a class="login1" href="/login?urlReturn=detail?idProduct=${phone.maDT}">Đăng nhập</a> <span>
	...
	<div class="container1">
		<div class="row">
			<div class="image1 col-7">
				<!--Hình ảnh-->
				<div class="hinhAnh1">
					<img src="images/sp/${phone.hinhAnh }" class="d-block w-75"
						height="500px">
				</div>

			</div>
			<div class="infor1 col-5">
				<div class="tenSanPham">${phone.tenDT}</div>
				<div class="donGia">
					<fmt:formatNumber var="giaSauKhiGiam"
						value="${phone.donGia*(1-phone.giamGia)}" maxFractionDigits="0" />
					<strike>${phone.donGia}đ</strike> <span>${giaSauKhiGiam}đ</span>
				</div>
				<div class="camKet">
					VÌ SAO CHỌN TopZoneShop?<br> <i class="fa fa-check"></i> Tặng
					phiếu giảm giá trị giá 350K<br> <i
						class="fa fa-check"></i> Cam kết chính hãng 100%<br> <i
						class="fa fa-check"></i> Miễn phí đổi trả trong 15 ngày<br> <i
				...
				<div class="row sizeText1">
					<div class="col-4 ">Dung lượng</div>
					<div class="col-8">
				...
				<div>
					<div class="row themGioHang">
						...
						<div class="col-7">
							<button data-maDT="${phone.maDT}" class="btn-primary btnThem"
								type="submit">
		...
		<div class="moTa">
			...
			<div class="moTaNoiDung">${phone.moTa}</div>
		</div>
		<!-- Benefit -->
