			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link text-white "
					href="${pageContext.request.contextPath}/admin/quanlyloaiDT.html">
						...
						</div> <span class="nav-link-text ms-1">Quản lý hãng điện thoại</span>
				</a></li>
				<li class="nav-item"><a class="nav-link text-white "
		...
		<div class="container-fluid py-4">
			...
			<form method="post" style="width: 600px; margin: auto;"
				...
				<div class="form-group">
					<input name="maDT" type="hidden" class="form-control" readonly
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
				</div>
				<div class="form-group">
					<label>Tên điện thoại</label> <input name="tenDT" type="text"
						class="form-control"
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
				</div>
				<div class="form-group">
