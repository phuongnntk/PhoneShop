				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm"><a
							class="opacity-5 text-dark" href="javascript:;">TopZoneAdmin</a></li>
									...
									<thead>
										<tr>
											<th
												...
												ĐT</th>
											<th
												class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Điện thoại</th>
											<th
										...
										<c:forEach var="item" items="${listPhone}">
											<tr>
												<td class="align-middle text-center text-sm">
													<p class="text-xs font-weight-bold mb-0">${item.maDT}</p>
												</td>
												<td>
													<div class="d-flex px-2 py-1">
														...
														<div class="d-flex flex-column justify-content-center">
															<h6 class="mb-0 text-sm">${item.tenDT}</h6>
														</div>
													</div>
												</td>
												...
												<td class="align-middle text-center"><span
													class="text-secondary text-xs font-weight-bold">${item.loaiDT.tenLoai}</span>
												</td>
												<td class="align-middle text-center"><span
													class="text-secondary text-xs font-weight-bold">${item.hangDT.tenHang}</span>
												</td>
												<td class="align-middle text-center"><a
													href="/admin/index/update?maDT=${item.maDT}"
													class="text-secondary font-weight-bold text-xs"> Chi
														tiết </a> <a href="/admin/index/delete?idDT=${item.maDT}"
													onclick="return confirm('Bạn có muốn xóa ${item.tenDT} không?');"
